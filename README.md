...
The 'WorkoutTime_Analytics_Databricks' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/WorkoutTime_Analytics_Databricks/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] WorkoutTime_Analytics_Databricks_etl` to your workspace.
